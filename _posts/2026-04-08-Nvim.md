...
|---------|--------------------|----------------------------------|
| p       | paragraphe         |                                  |
| a       | selection + around | ap : select paragraph and around |
| i       | selection + inside | ip : select paragraph and inside |
...
gc + motion
Commenter une sélection par motion (ex: gcap = paragraphe)
gc en Visual modeCommenter la sélection visuelle
[count]gccEx: 5gcc = commenter 5 lignes
