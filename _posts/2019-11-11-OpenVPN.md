...
docker create --name=openvpn-as --cap-add=NET_ADMIN -e PUID=1000 -e PGID=1000 -e TZ=Europe/Paris -p 127.0.0.1:943:943 -p 5002:9443 -v /config --restart unless-stopped linuxserver/openvpn-as
...
```
On your browser :  
https://locahost:943/admin -> webadmin (admin/password)  
Create a new user and delete "admin"   
Then reconnect as your newly created user to download the certificate
