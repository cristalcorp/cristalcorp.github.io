...
docker create   --name=openvpn-as   --cap-add=NET_ADMIN   -e PUID=1000   -e PGID=1000   -e TZ=Europe/London   -p 127.0.0.1:8085:943   -p 5002:9443   -v /config   --restart unless-stopped   linuxserver/openvpn-as
