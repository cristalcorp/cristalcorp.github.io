...
Also known as residual sum of square where $$ \bar{y} $$ is a mean value of $$ y $$, takes the total absolute error and normalizes it, by dividing by the total absolute error of the sample predictor.
