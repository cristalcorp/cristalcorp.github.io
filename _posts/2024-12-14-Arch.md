...
# Hyprland
yay -S hyprland waybar swaync hyprshot hyprlauncher wlogout hyprlock
# Terminal
...
#### Kitty
edit ~/.config/kitty/kitty.conf and add this line to auto start tmux when you launch kitty
```bash
