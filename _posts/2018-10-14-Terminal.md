...
### Fonts
Nerd Fonts :<br>
[https://github.com/ryanoasis/nerd-fonts.git](https://github.com/ryanoasis/nerd-fonts.git)
{% highlight bash %}
...
We'll choose the AtomicCoding's Configuration with a little tweak :<br>
In your ~/.zshrc :
