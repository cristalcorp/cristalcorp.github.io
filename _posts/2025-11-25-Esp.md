...
#### Da build
in order to build and especially upload, you ll use Platformio. I tried to install it system wide, it did compile the firmware, but during the upload step, it tried to pip-install some modules and got stuck. Therefore I would recommend the following :
